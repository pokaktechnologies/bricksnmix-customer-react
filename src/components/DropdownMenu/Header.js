        ...
        <Container>
          <Nav className="w-100 d-flex align-items-center" style={categoriesStyle}>
            ...
            >
              ...
              <Dropdown.Menu>
                <Dropdown.Item href="#floor-screed">Floor Screed</Dropdown.Item>
                <Dropdown.Item href="#rush-coat">Rush Coat</Dropdown.Item>
                <Dropdown.Item href="#cement-plaster">Cement Plaster</Dropdown.Item>
                <Dropdown.Item href="#block-work-mortar">Block Work Mortar</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
